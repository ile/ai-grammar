...
function composeResult(original, content) {
  let contentHtml;

  if (content == 'Grammar OK.') {
    contentHtml = `
      ...
      <div style="display:flex; align-items: center; ">
        ...
        <svg width="28" height="28" viewBox="0 0 94 94" fill="none" xmlns="http://www.w3.org/2000/svg">
  <circle cx="47" cy="47" r="44" fill="#22c55e"/>
  <path d="m 33.186017,50.279025 10,10 22,-24" 
...
function updateExistingOverlay(existing, type, original, content) {
  ...
  if (type === 'loading') {
    ...
    contentHtml = composeResult(original, content);
  } else if (type === 'error') {
